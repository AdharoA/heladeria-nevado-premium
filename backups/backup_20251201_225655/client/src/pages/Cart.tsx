  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      <div className="container mx-auto px-4 py-8">
        <h2 className="text-3xl font-bold mb-8 dark:text-white">Mi Carrito</h2>
                  ...
                  <CardContent className="p-6">
                    <div className="flex gap-6">
                      ...
                      <div className="flex-1">
                        <h3 className="font-bold text-lg mb-2 dark:text-white">{item.product?.name}</h3>
                        <p className="text-gray-600 text-sm mb-4 dark:text-gray-300">{item.product?.description}</p>
                        <p className="text-xl font-bold text-blue-600 mb-4 dark:text-blue-400">
