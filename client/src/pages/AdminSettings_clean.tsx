...
export default function AdminSettings() {
    ...
    const handleSaveAll = async () => {
        try {
            // Save settings one by one to ensure each one completes
            for (const [key, value] of Object.entries(formData)) {
                if (value !== undefined && value !== null) {  // Only save non-null values
            ...
            <div className="container mx-auto max-w-4xl">
                ...
                <Tabs defaultValue="general" className="space-y-4">
                    <TabsList>
                        ...
                        <TabsTrigger value="contact" className="gap-2"><Phone className="w-4 h-4" /> Contacto</TabsTrigger>
                    </TabsList>
                    ...
                    <TabsContent value="general">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Configura el nombre, logo y descripción de tu tienda.</CardDescription>
                            </CardHeader>
