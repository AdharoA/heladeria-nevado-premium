            ...
            <Card>
              <CardContent className="p-6 flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@nevado.pe</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6 flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Huaraz, Ancash, Perú</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6 flex gap-4">
                ...
                <div>
                  ...
                  <a href="https://wa.me/51943123456" className="text-blue-600 hover:underline">
                    Enviar mensaje
                  </a>
                </div>
              </CardContent>
